        ...
        <div className="glass-card p-6 rounded-3xl text-center relative overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-primary-500/10">
            {showConfetti && (
                <div className="absolute inset-0 pointer-events-none z-0">
                    {/* Abstract confetti implementation using CSS blobs or similar would be cool, keeping it simple for now */}
            ...
            <div className="relative z-10">
                <h2 className="text-sm font-bold text-slate-500 uppercase tracking-widest mb-2">Projected CGPA</h2>

                <div className={cn(
                    "text-6xl font-black mb-2 transition-colors duration-500 flex items-center justify-center gap-2",
                ...
                <p className={cn(
                    "font-medium text-lg animate-fade-in",
                    getGradeColor(gpa)
                )}>
                    {getMessage(gpa)}
                </p>
